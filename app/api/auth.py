...
from app.schemas.auth import RequestOtpIn, RequestOtpOut, VerifyOtpIn, VerifyOtpOut
...
async def request_otp(
    ...
    Always returns the same response whether the phone is new or existing —
    this prevents enumeration of registered numbers.
    """
